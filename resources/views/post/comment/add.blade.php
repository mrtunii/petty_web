                        ...
                        <div class="tg-loginsignup">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
                                <div class="tg-logingarea">
                                    <h2 class="roboto">კომენტარის დამატება</h2>
                                    <form class="tg-formtheme tg-formloging" method="post" action="/comment/submit" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        @if($errors->any())
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                <input type="text" name="seen_date" id="datetime" class="form-control roboto"  placeholder="როდის ნახეთ?">
                                            </div>
                                            <input type="hidden" name="post_id" value="{{ $post_id }}">
                                            <div class="form-group">
                                                <input type="text" id="autocomplete" name="seen_address" class="form-control roboto" placeholder="დაახლოებით რა ადგილას ნახეთ ?">
                                                <input type="hidden" name="long" id="long">
                                                <input type="hidden" name="lat" id="lat">
                                            </div>
                                            <div class="form-group">
                                                <span class="roboto">აირჩიეთ სურათი (თუ გადაუღეთ)</span>
                                                <input type="file"  name="image" class="form-control " accept="image/*" capture="camera" multiple>
                                            </div>
                                            <div class="form-group">
